	...
	const main = () => {
		...
		var mods = {
			...
			"player" : {
				...
				"increasedMiningNodeHP" : {
					"title" : "Increased Mining Node HP",
					"values" : [1000, "num", "+"]
				},
		...
		var krypto = {
			...
			"modifiers":{
				...
				"increasedChanceToDoubleLootCombat" : mods.player["increasedChanceToDoubleLootCombat"].values[0],
				...
				"increasedMiningNodeHP" : mods.player["increasedMiningNodeHP"].values[0],
